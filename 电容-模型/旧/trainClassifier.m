...
% 由 MATLAB 于 2023-12-11 20:31:13 自动生成
...
predictorNames = {'C11', 'C12', 'C21', 'C22', 'C31', 'C32', 'C41', 'C42'};
predictors = inputTable(:, predictorNames);
response = inputTable.Var12;
...
classificationNeuralNetwork = fitcnet(...
    ...
    'IterationLimit', 1000, ...
    'Standardize', true, ...
    'ClassNames', [2.1; 3; 3.3; 4.2; 4.5; 9; 11.7; 20; 80]);
...
% 向结果结构体中添加字段
trainedClassifier.RequiredVariables = {'C11', 'C12', 'C21', 'C22', 'C31', 'C32', 'C41', 'C42'};
