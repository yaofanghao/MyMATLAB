...
% to visualize high-dimensional data in MATLAB(R), using
...
% the bivariate scatter plots between our five variables, along with a
...
%%
% The points in each scatter plot are color-coded by the number of
